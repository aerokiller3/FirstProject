...
namespace RevitOpening
{
    public class TOFamily
    {
        ...
        public TOFamily(string name, string depthParametr,string heightParametr = null, string widthParametr = null,string diametrParametr = null)
        {
            Name = name;
