namespace RevitOpening.Logic
{
    ...
    internal static class TasksToOpeningsChanger
    {
        public static List<Element> SwapAllTasksToOpenings(Document currentDocument)
        {
            ...
            var wallElipticalTasks = currentDocument.GetTasksByName(Families.WallElipticalTaskFamily);
            ...
            (var correctWallElipticalTasks, var incorrectWallElipticalTasks) = GetCheckedBoxes(wallElipticalTasks);
